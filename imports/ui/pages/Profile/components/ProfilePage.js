...
function MediaCard({
  ...
  if (propsReady) {
    ...
    // console.log("HELLLLLLLLLLLLLLOOOOOOOOOOOOOOOO");
    // console.log(imgURL);
    // console.log(imgpath);
...
export default withTracker(() => {
  const subscriberHandles = [Meteor.subscribe('issues.stateCount'), Meteor.subscribe('user'), Meteor.subscribe('files.all')];
